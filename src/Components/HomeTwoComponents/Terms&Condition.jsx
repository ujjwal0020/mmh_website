...
const TermsAndConditions = () => {
  return (
    <div className="container mx-auto p-4">
      ...
      <p className="text-sm text-gray-500 mb-4">Last updated: July 21, 2024</p>
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li className="mb-2">
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to MMH.</p>
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          <p><strong>Terms and Conditions</strong> (also referred as &quot;Terms&quot;) mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement has been created with the help of the <a href="https://www.termsfeed.com/terms-conditions-generator/" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">Terms and Conditions Generator</a>.</p>
        </li>
        <li className="mb-2">
          <p><strong>Third-party Social Media Service</strong> means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.</p>
        </li>
        <li className="mb-2">
          <p><strong>Website</strong> refers to MMH, accessible from <a href="https://mmh-website-jet.vercel.app/" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">https://mmh-website-jet.vercel.app/</a></p>
        </li>
        <li className="mb-2">
