...
<li>
<p><strong>Website</strong> refers to MMH, accessible from <a href="https://mmh-website-jet.vercel.app/" rel="external nofollow noopener" target="blank">https://mmh-website-jet.vercel.app/</a></p>
</li>
<li>
...
<h4 className="text-xl font-semibold mt-3">Personal Data</h4>
...
<h4 className="text-xl font-semibold mt-3">Usage Data</h4>
...
<h4 className="text-xl font-semibold mt-3">Tracking Technologies and Cookies</h4>
...
<p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn more about cookies on <a href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies" target="blank">TermsFeed website</a> article.</p>
...
<h4 className="text-xl font-semibold mt-3">Business Transactions</h4>
<p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
<h4 className="text-xl font-semibold mt-3">Law enforcement</h4>
<p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
<h4 className="text-xl font-semibold mt-3">Other legal requirements</h4>
...
<h3 className="text-xl font-semibold mt-4">Usage, Performance and Miscellaneous</h3>
